...
const defaultDestro = {
    ...
    servers: [
        {
            id: 'CAS-1.12.2',
            address: 'concert.virtualhkc.com:25565',
            ...
            modules: [
                {
                    id: 'casconcert.zip',
                    name: 'CAS Concert Mod',
                    type: 'File',
                    artifact: {
                        path: 'mods/casconcert.zip',
                    },
                },
            ],
        },
...
exports.pullRemote = function () {
    ...
    return new Promise((resolve, reject) => {
        const distroURL = 'https://d35i8e8nn2fgzy.cloudfront.net/callstar/versions.txt'
        const opts = {
            url: distroURL,
            timeout: 2500
        }
        ...
        request(opts, (error, resp, body) => {
            if (!error) {
                try {
                    defaultDestro.servers[0].modules[0].artifact.url = `https://d35i8e8nn2fgzy.cloudfront.net/callstar/${body}`;
                    data = DistroIndex.fromJSON(JSON.parse(defaultDestro))
                } catch (e) {
                    reject(e)
                }
